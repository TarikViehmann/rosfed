...
Source0:        https://github.com/ros2-gbp/ament_cmake-release/archive/release/iron/ament_cmake_export_include_directories/2.0.3-1.tar.gz#/ros2-iron-ament_cmake_export_include_directories-2.0.3-source0.tar.gz
...
Provides:  ros2-iron-ament_cmake_export_include_directories = 2.0.3-1
Obsoletes: ros2-iron-ament_cmake_export_include_directories < 2.0.3-1
...
Provides: ros2-iron-ament_cmake_export_include_directories-devel = 2.0.3-1
Obsoletes: ros2-iron-ament_cmake_export_include_directories-devel < 2.0.3-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.2.0.3-1
