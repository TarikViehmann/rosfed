...
Source0:        https://github.com/ros2-gbp/image_common-release/archive/release/iron/camera_calibration_parsers/4.2.2-1.tar.gz#/ros2-iron-camera_calibration_parsers-4.2.2-source0.tar.gz
...
Provides:  ros2-iron-camera_calibration_parsers = 4.2.2-1
Obsoletes: ros2-iron-camera_calibration_parsers < 4.2.2-1
...
Provides: ros2-iron-camera_calibration_parsers-devel = 4.2.2-1
Obsoletes: ros2-iron-camera_calibration_parsers-devel < 4.2.2-1
