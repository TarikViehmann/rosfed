...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/costmap_queue/1.2.5-2.tar.gz#/ros2-iron-costmap_queue-1.2.5-source0.tar.gz
...
Provides:  ros2-iron-costmap_queue = 1.2.5-1
Obsoletes: ros2-iron-costmap_queue < 1.2.5-1
...
Provides: ros2-iron-costmap_queue-devel = 1.2.5-1
Obsoletes: ros2-iron-costmap_queue-devel < 1.2.5-1
