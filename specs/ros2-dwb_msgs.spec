...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/dwb_msgs/1.2.5-2.tar.gz#/ros2-iron-dwb_msgs-1.2.5-source0.tar.gz
...
Provides:  ros2-iron-dwb_msgs = 1.2.5-1
Obsoletes: ros2-iron-dwb_msgs < 1.2.5-1
...
Provides: ros2-iron-dwb_msgs-devel = 1.2.5-1
Obsoletes: ros2-iron-dwb_msgs-devel < 1.2.5-1
