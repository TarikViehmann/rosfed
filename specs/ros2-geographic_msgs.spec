...
Source0:        https://github.com/ros2-gbp/geographic_info-release/archive/release/iron/geographic_msgs/1.0.5-1.tar.gz#/ros2-iron-geographic_msgs-1.0.5-source0.tar.gz
...
Provides:  ros2-iron-geographic_msgs = 1.0.5-1
Obsoletes: ros2-iron-geographic_msgs < 1.0.5-1
...
Provides: ros2-iron-geographic_msgs-devel = 1.0.5-1
Obsoletes: ros2-iron-geographic_msgs-devel < 1.0.5-1
...
%changelog
* Sat Oct 21 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.1.0.5-1
