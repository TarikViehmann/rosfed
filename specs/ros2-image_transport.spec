...
Source0:        https://github.com/ros2-gbp/image_common-release/archive/release/iron/image_transport/4.2.2-1.tar.gz#/ros2-iron-image_transport-4.2.2-source0.tar.gz
...
Provides:  ros2-iron-image_transport = 4.2.2-1
Obsoletes: ros2-iron-image_transport < 4.2.2-1
...
Provides: ros2-iron-image_transport-devel = 4.2.2-1
Obsoletes: ros2-iron-image_transport-devel < 4.2.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.4.2.2-1
