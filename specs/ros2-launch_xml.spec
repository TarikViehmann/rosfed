...
Source0:        https://github.com/ros2-gbp/launch-release/archive/release/iron/launch_xml/2.0.2-1.tar.gz#/ros2-iron-launch_xml-2.0.2-source0.tar.gz
...
Provides:  ros2-iron-launch_xml = 2.0.2-1
Obsoletes: ros2-iron-launch_xml < 2.0.2-1
...
Provides: ros2-iron-launch_xml-devel = 2.0.2-1
Obsoletes: ros2-iron-launch_xml-devel < 2.0.2-1
