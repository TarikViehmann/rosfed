...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_behaviors/1.2.5-2.tar.gz#/ros2-iron-nav2_behaviors-1.2.5-source0.tar.gz

Patch0: ros2-nav2_behaviors.disable-warnings.patch
...
Provides:  ros2-iron-nav2_behaviors = 1.2.5-1
Obsoletes: ros2-iron-nav2_behaviors < 1.2.5-1
...
Provides: ros2-iron-nav2_behaviors-devel = 1.2.5-1
Obsoletes: ros2-iron-nav2_behaviors-devel < 1.2.5-1
