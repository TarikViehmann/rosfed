...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_core/1.2.5-2.tar.gz#/ros2-iron-nav2_core-1.2.5-source0.tar.gz
...
Provides:  ros2-iron-nav2_core = 1.2.5-1
Obsoletes: ros2-iron-nav2_core < 1.2.5-1
...
Provides: ros2-iron-nav2_core-devel = 1.2.5-1
Obsoletes: ros2-iron-nav2_core-devel < 1.2.5-1
