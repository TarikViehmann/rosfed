...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_regulated_pure_pursuit_controller/1.2.5-2.tar.gz#/ros2-iron-nav2_regulated_pure_pursuit_controller-1.2.5-source0.tar.gz

Patch0: ros2.regulated_pure_pursuit_controller.disable_warnings.patch
...
Provides:  ros2-iron-nav2_regulated_pure_pursuit_controller = 1.2.5-1
Obsoletes: ros2-iron-nav2_regulated_pure_pursuit_controller < 1.2.5-1
...
Provides: ros2-iron-nav2_regulated_pure_pursuit_controller-devel = 1.2.5-1
Obsoletes: ros2-iron-nav2_regulated_pure_pursuit_controller-devel < 1.2.5-1
