...
Source0:        https://github.com/ros2-gbp/python_qt_binding-release/archive/release/iron/python_qt_binding/1.2.3-2.tar.gz#/ros2-iron-python_qt_binding-1.2.3-source0.tar.gz
...
Provides:  ros2-iron-python_qt_binding = 1.2.3-1
Obsoletes: ros2-iron-python_qt_binding < 1.2.3-1
...
Provides: ros2-iron-python_qt_binding-devel = 1.2.3-1
Obsoletes: ros2-iron-python_qt_binding-devel < 1.2.3-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.1.2.3-1
