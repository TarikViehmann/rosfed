...
Source0:        https://github.com/ros2-gbp/rcl-release/archive/release/iron/rcl_action/6.0.4-1.tar.gz#/ros2-iron-rcl_action-6.0.4-source0.tar.gz
...
Provides:  ros2-iron-rcl_action = 6.0.4-1
Obsoletes: ros2-iron-rcl_action < 6.0.4-1
...
Provides: ros2-iron-rcl_action-devel = 6.0.4-1
Obsoletes: ros2-iron-rcl_action-devel < 6.0.4-1
