...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/iron/rclcpp_components/21.0.4-1.tar.gz#/ros2-iron-rclcpp_components-21.0.4-source0.tar.gz
...
Provides:  ros2-iron-rclcpp_components = 21.0.4-1
Obsoletes: ros2-iron-rclcpp_components < 21.0.4-1
...
Provides: ros2-iron-rclcpp_components-devel = 21.0.4-1
Obsoletes: ros2-iron-rclcpp_components-devel < 21.0.4-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.21.0.4-1
