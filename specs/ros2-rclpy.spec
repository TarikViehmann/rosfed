...
Source0:        https://github.com/ros2-gbp/rclpy-release/archive/release/iron/rclpy/4.1.4-1.tar.gz#/ros2-iron-rclpy-4.1.4-source0.tar.gz
...
Provides:  ros2-iron-rclpy = 4.1.4-1
Obsoletes: ros2-iron-rclpy < 4.1.4-1
...
Provides: ros2-iron-rclpy-devel = 4.1.4-1
Obsoletes: ros2-iron-rclpy-devel < 4.1.4-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.4.1.4-1
