...
Source0:        https://github.com/ros2-gbp/rcpputils-release/archive/release/iron/rcpputils/2.6.2-1.tar.gz#/ros2-iron-rcpputils-2.6.2-source0.tar.gz
...
Provides:  ros2-iron-rcpputils = 2.6.2-1
Obsoletes: ros2-iron-rcpputils < 2.6.2-1
...
Provides: ros2-iron-rcpputils-devel = 2.6.2-1
Obsoletes: ros2-iron-rcpputils-devel < 2.6.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.2.6.2-1
