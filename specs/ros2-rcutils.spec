...
Source0:        https://github.com/ros2-gbp/rcutils-release/archive/release/iron/rcutils/6.2.2-2.tar.gz#/ros2-iron-rcutils-6.2.2-source0.tar.gz
...
Provides:  ros2-iron-rcutils = 6.2.2-1
Obsoletes: ros2-iron-rcutils < 6.2.2-1
...
Provides: ros2-iron-rcutils-devel = 6.2.2-1
Obsoletes: ros2-iron-rcutils-devel < 6.2.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.6.2.2-1
