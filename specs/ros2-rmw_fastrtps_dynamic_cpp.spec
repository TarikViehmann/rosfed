...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/iron/rmw_fastrtps_dynamic_cpp/7.1.2-1.tar.gz#/ros2-iron-rmw_fastrtps_dynamic_cpp-7.1.2-source0.tar.gz
...
Provides:  ros2-iron-rmw_fastrtps_dynamic_cpp = 7.1.2-1
Obsoletes: ros2-iron-rmw_fastrtps_dynamic_cpp < 7.1.2-1
...
Provides: ros2-iron-rmw_fastrtps_dynamic_cpp-devel = 7.1.2-1
Obsoletes: ros2-iron-rmw_fastrtps_dynamic_cpp-devel < 7.1.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.7.1.2-1
