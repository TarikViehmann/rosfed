...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/iron/ros2run/0.25.2-1.tar.gz#/ros2-iron-ros2run-0.25.2-source0.tar.gz
...
Provides:  ros2-iron-ros2run = 0.25.2-1
Obsoletes: ros2-iron-ros2run < 0.25.2-1
...
Provides: ros2-iron-ros2run-devel = 0.25.2-1
Obsoletes: ros2-iron-ros2run-devel < 0.25.2-1
