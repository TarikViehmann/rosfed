Name:           ros2-iron-ros_gz
Version:        0.245.0
Release:        1%{?dist}
Summary:        ROS package ros_gz

License:        Apache 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz/0.245.0-1.tar.gz#/ros2-iron-ros_gz-0.245.0-source0.tar.gz
...
Requires:       ros2-iron-ros_gz_bridge
Requires:       ros2-iron-ros_gz_image
Requires:       ros2-iron-ros_gz_sim
Requires:       ros2-iron-ros_gz_sim_demos

Provides:  ros2-iron-ros_gz = 0.245.0-1
Obsoletes: ros2-iron-ros_gz < 0.245.0-1
...
Requires:       ros2-iron-ros_gz_bridge-devel
Requires:       ros2-iron-ros_gz_image-devel
Requires:       ros2-iron-ros_gz_sim-devel
Requires:       ros2-iron-ros_gz_sim_demos-devel

Provides: ros2-iron-ros_gz-devel = 0.245.0-1
Obsoletes: ros2-iron-ros_gz-devel < 0.245.0-1
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,ros_gz/include/,share/ros_gz/cmake} \
...
%changelog
* Wed Aug 23 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.0.245.0-1
