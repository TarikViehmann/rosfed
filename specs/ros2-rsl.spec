...
Source0:        https://github.com/ros2-gbp/RSL-release/archive/release/iron/rsl/0.2.2-2.tar.gz#/ros2-iron-rsl-0.2.2-source0.tar.gz
...
Provides:  ros2-iron-rsl = 0.2.2-1
Obsoletes: ros2-iron-rsl < 0.2.2-1
...
Provides: ros2-iron-rsl-devel = 0.2.2-1
Obsoletes: ros2-iron-rsl-devel < 0.2.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.0.2.2-1
