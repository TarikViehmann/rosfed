...
Source0:        https://github.com/SteveMacenski/slam_toolbox-release/archive/release/iron/slam_toolbox/2.7.2-1.tar.gz#/ros2-iron-slam_toolbox-2.7.2-source0.tar.gz
...
Provides:  ros2-iron-slam_toolbox = 2.7.2-1
Obsoletes: ros2-iron-slam_toolbox < 2.7.2-1
...
Provides: ros2-iron-slam_toolbox-devel = 2.7.2-1
Obsoletes: ros2-iron-slam_toolbox-devel < 2.7.2-1
...
%changelog
* Wed Dec 06 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - iron.2.7.2-1
